...
const modal_react = document.querySelector(".modal_react");
...
const modal_close_btn4 = document.querySelector(".close_btn4");
...
function modalEvent() {
  ...
  modalOpen4.addEventListener("click", () => {
    modal_react.classList.remove("off");
    overlay.classList.remove("off");
  });
  ...
  modal_close_btn4.addEventListener("click", () => {
    modal_react.classList.add("off");
    overlay.classList.add("off");
  });
